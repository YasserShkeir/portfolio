...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        I'm a CS graduate interested in Junior Software Engineering roles. I can work in both
        frontend or backend. My dedication is my secret weapon in acing any role that I'm assigned.
      </SectionText>
